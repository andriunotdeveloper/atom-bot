...
class RestrictReactionCommand extends Command {
	...
	async exec(message, { member, reason }) {
		...
		try {
			...
			return message.channel.send(`<:disagree:745003854017593354> There was an error muting this member: \`${error}\``);
		}
		...
		return message.util.send(`<:agree:745003896522670100> Successfully reaction restricted **${member.user.tag}**`);
	}
}
