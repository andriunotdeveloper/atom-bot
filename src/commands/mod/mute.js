...
class MuteCommand extends Command {
	...
	async exec(message, { member, duration, reason }) {
		...
		if (!muteRole) return message.channel.send('<:disagree:745003854017593354> There is no mute role configured on this server.');
		...
		return message.util.send(`<:agree:745003896522670100> Successfully muted **${member.user.tag}**`);
	}
}
