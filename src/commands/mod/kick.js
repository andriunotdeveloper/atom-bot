...
class KickCommand extends Command {
	...
	async exec(message, { member, reason }) {
		...
		try {
			...
			return message.channel.send('<:disagree:745003854017593354> I could not kick this user.');
		}
		...
		return sentMessage.edit(`<:agree:745003896522670100> Successfully kicked **${member.user.tag}**`);
	}
}
