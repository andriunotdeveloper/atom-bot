...
class ToggleRoleStateCommand extends Command {
	...
	async exec(message) {
		...
		if (roleState) {
			...
			return message.util.send('<:agree:745003896522670100> Successfully removed all records!');
		}
		...
		return message.util.send('<:agree:745003896522670100> Successfully inserted all the records!');
	}
}
