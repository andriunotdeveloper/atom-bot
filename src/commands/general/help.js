...
class HelpCommand extends Command {
	...
	async execCommandList(message) {
		...
		try {
			...
			if (shouldReply) return message.util.send('<:agree:745003896522670100> I\'ve sent you a DM with the command list.');
		} catch (err) {
			if (shouldReply) return message.util.send('<:disagree:745003854017593354> I could not send you the command list in DMs.');
		}
